    ...
    <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <li><a className="hover:underline text-xl py-2 hover:bg-gray-100 rounded-2xl" href="#inicio" onClick={() => setIsOpen(false)}>Inicio</a></li>
            <li><a className="hover:underline text-xl py-2 hover:bg-gray-100 rounded-2xl" href="#sobre-mi" onClick={() => setIsOpen(false)}>Acerca de mí</a></li>
            <li><a className="hover:underline text-xl py-2 hover:bg-gray-100 rounded-2xl" href="#proyectos" onClick={() => setIsOpen(false)}>Proyectos</a></li>
          </motion.ul>
        )}
      </AnimatePresence>
